export function Precare(props) {
    return (
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" style={{ width: '150px', height: '150px', margin: 'auto', display: 'block' }} viewBox="0 0 512 512">
            ...
            <path d="M0,256C0,114.61,114.61,0,256,0S512,114.63,512,256,397.38,512,256,512,0,397.39,0,256Z" fill="#1976D2" />
